<div class="user-dashboard-left">
    <div class="dashboard-bar fave-screen-fix">
        <ul class="board-panel-menu">
            <li class=active> <a href="http://houzez01.favethemes.com/my-profile/"><i class="fa fa-user"></i>My profile</a> </li>
            <li> <a href="http://houzez01.favethemes.com/my-properties/"><i class="fa fa-building"></i>My Properties</a>
                <ul class="sub-menu">
            ...
            <li> <a href="http://houzez01.favethemes.com/add-new-property/"><i class="fa fa-plus-circle"></i>Add new property</a> </li>
            <li> <a href="http://houzez01.favethemes.com/favorite-properties/"><i class="fa fa-heart"></i>Favourite properties</a> </li>
