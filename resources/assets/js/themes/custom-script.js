...
"use strict";
    ...
    var houzez_date_language = VARIABLE_JS.houzez_date_language;
    var currency_position = VARIABLE_JS.currency_position;
    var stripe_page = VARIABLE_JS.stripe_page;
    var twocheckout_page = VARIABLE_JS.twocheckout_page;
   ...
   function property_menu_h(ele){
    ...
    if( $('#houzez_mortgage_calculate').length > 0 ) {
        $('#houzez_mortgage_calculate').click(function(e) {
            ...
            var monthly_payment = VARIABLE_JS.monthly_payment;
            var weekly_payment = VARIABLE_JS.weekly_payment;
            var bi_weekly_payment = VARIABLE_JS.bi_weekly_payment;
    ...
    function this_sticky(ele){
        ...
        if($(sticky_wrap).hasClass('header-section-4')) {
            $('.sticky_nav .logo-desktop img').attr('src',VARIABLE_JS.simple_logo);
        }
    ...
    $('.prop_featured').change( function() {
        ...
        var currency_symbol = VARIABLE_JS.currency_symbol;
        var currency_position = VARIABLE_JS.currency_position;
